var dsp = {code:"DSPNWLV", token:"HGX5LRxgkzkBRixt", secret:"cJ1RJnoPIsavMiko3N5hQ7ky"};
...
var param = {
    // trans_id:"KO1292030",
    trans_id: ("GTX"+Math.random().toString(36).substring(2,15)).toUpperCase(),
    shipping_fee:0,
    voucher:60,
    coins:0,
    subtotal_amount:243.80,
    total_amount:183.80,
    customer:customer,
    seller:seller,
    items:[{
        description:"Dishwashing Kit DIY by BritePH",
        variant:"LEMON SCENT",
        qty:1,
        unit_price:243.80,
        total_price:243.80,
