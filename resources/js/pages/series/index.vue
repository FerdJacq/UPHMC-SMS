            ...
            <template #content>
              ...
              <div class="table-responsive mb-3">
                ...
                >
                    ...
                    <p-column header="Series Number">
                      <template #body="{data}">
                        <span>{{ data.series_no }}</span>
                      </template>
                    </p-column>
                    <p-column header="Series">
                      <template #body="{data}">
                        <span>{{ data.complete_no }}</span>
                      </template>
                    </p-column>
    ...
    >
      ...
      <v-form ref="form" tag="form" class="row rg-15">
        ...
        <div class="col-12 text-center">
            ...
            <span class="label-title">Service Provider Prefix + Prefix + Series + Suffix</span>
            <h3>{{ sampleOutput }}</h3>
        </div>
...
export default {
  ...
  computed: {
    sampleOutput() {
      ...
      {
        let dsp_code = this.dsp_list.filter(e=>e.id==this.dialog.data.service_provider_id)[0].prefix;
  ...
  methods: {
    ...
    updateTable(Loading=true) {
      ...
      SeriesService.list(this.table.params)
      .then((response) => {
